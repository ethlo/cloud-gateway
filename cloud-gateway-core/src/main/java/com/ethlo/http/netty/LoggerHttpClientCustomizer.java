...
public class LoggerHttpClientCustomizer implements HttpClientCustomizer
{
    ...
    public LoggerHttpClientCustomizer(final HttpLoggingConfiguration httpLoggingConfiguration, final DataBufferRepository dataBufferRepository)
    {
        this.captureEnabled = httpLoggingConfiguration.getCapture().isEnabled();
