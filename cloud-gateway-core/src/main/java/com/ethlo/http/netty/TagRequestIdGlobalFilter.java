...
public class TagRequestIdGlobalFilter implements GlobalFilter, Ordered
{
    ...
    private static final Field REQUEST_FIELD = Objects.requireNonNull(ReflectionUtils.findField(DefaultServerWebExchange.class, field -> "request".equals(field.getName())), "No request field found");
    ...
    {
        // Override the request.getId()
        ReflectionUtils.setField(REQUEST_FIELD, exchange, new RequestIdWrapper(exchange.getRequest(), RequestIdWrapper.generateId()));
