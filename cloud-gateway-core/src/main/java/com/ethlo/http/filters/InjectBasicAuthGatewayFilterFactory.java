...
@Component
public class InjectBasicAuthGatewayFilterFactory extends AbstractGatewayFilterFactory<InjectBasicAuthGatewayFilterFactory.@NonNull Config>
{
    ...
    public GatewayFilter apply(Config config)
    {
        return new GatewayFilter()
        {
            ...
            public Mono<@NonNull Void> filter(@NotNull ServerWebExchange exchange, @NotNull GatewayFilterChain chain)
            {
                ...
                logger.debug("Sending Authorization header for request {} (redacted): Basic {}", requestId, RedactUtil.redact(base64Encoded, 3));
